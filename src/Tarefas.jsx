...
function Tarefas() {
    ...
    function limparListaTarefas(id){
        setTarefas([]);
    }
        ...
        <div className="mt-4 row">
            ...
            <div className="col-6">
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="button" className="btn btn-outline-secondary"
                        onClick={limparFormulario}>Limpar Tarefas</button>
                    ...
                    <button type="button" className="btn btn-outline-secondary"
                        onClick={limparListaTarefas}>Eliminar todas as Tarefas</button>                       
                </form>
            </div>
                ...
                <ul className="list-group mt-4">
                    {tarefas.map(tarefa => (
                        <li key={tarefa.id} className="list-group-item">
                            ...
                            <button type="button" className="btn btn-outline-secondary"
                                onClick={() => eliminaTarefa(tarefa.id)}>Eliminar Tarefa</button>
                        </li>
                    ))}
                </ul>
            </div>
